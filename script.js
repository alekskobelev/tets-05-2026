...
const translations = {
    ru: {
        ...
        'service2-desc': 'Анализ и оптимизация облаков точек и полигональных моделей (STL) в специализированном ПО Hexagon. Извлечение базовых геометрических примитивов.',
